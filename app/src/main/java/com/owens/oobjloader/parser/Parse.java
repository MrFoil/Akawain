...
public class Parse {
    ...
    public Parse( String fileContent, BuilderInterface builder) throws FileNotFoundException, IOException {
        this.builder = builder;
        parseObjFileContent(fileContent);

    }


    @TargetApi(android.os.Build.VERSION_CODES.KITKAT)
    private void parseObjFileContent(String content) throws IOException{
        int lineCount = 0;
